...
function Authentication({onSubmit, title,onEmailHandler, onPasswordHandler, buttonText, text, linkText, linkRoute}) {
    return (
        <form className="authentication" onSubmit={onSubmit}>
            ...
            <div className="authentication__bottom">
                ...
                <Link className="authentication__link" to={linkRoute}>{linkText}</Link>
            </div>
        </form>
    )
}
